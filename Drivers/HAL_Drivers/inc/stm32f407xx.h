...
// ---------- NVIC Enable ----------
#define NVIC_EnableIRQ(IRQn) (*NVIC_ISER0 = (1 << ((uint32_t)(IRQn))))
...
/* RCC */
#define RCC_APB1ENR_TIM3EN  (1 << 1)  // Bit 1 enables TIM3
...
/* NVIC */
#define TIM3_IRQ_NUM        29  // TIM3 IRQn number
#define ENABLE_TIM3_IRQ()   (NVIC_ISER0[0] = (1 << TIM3_IRQ_NUM))
#define TIM3_IRQn 29
